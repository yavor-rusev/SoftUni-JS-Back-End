const { getAllMovies, getMovieById } = require('../services/service');
...
module.exports = {
    homeController: async (req, res) => {
        try {
            ...
            res.render('home', { tabTitle: 'Home', movies });
    ...
    searchController: async (req, res) => {
        ...
        res.render('search', { tabTitle: 'Search', search, results});
    },
    ...
    detailsController: async (req, res) => {
        try {
            ...
            res.render('details', { tabTitle: 'Details', movie });
